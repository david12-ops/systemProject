...
public class SideBar extends VBox {
    ...
    public SideBar() {
        ...
        this.setBackground(new Background(new BackgroundFill(Color.web("#D9D89F"), radiiSideBar, Insets.EMPTY)));
        ...
        VBox extraButtonsBox = new VBox(10, importantButton, scheduledButton, allMailButton, spamButton, trashButton);
        extraButtonsBox.setAlignment(Pos.CENTER);
        extraButtonsBox.setVisible(false);
        extraButtonsBox.setManaged(false);
        extraButtonsBox.setBorder(new Border(new BorderStroke(Color.web("rgb(243, 245, 224)"), BorderStrokeStyle.SOLID,
                radiiButtonBox, new BorderWidths(2))));

        extraButtonsBox
                .setBackground(new Background(new BackgroundFill(Color.WHITESMOKE, radiiButtonBox, Insets.EMPTY)));
        ...
        getChildren().addAll(addButton, inboxButton, starredButton, snoozedButton, sentButton, draftsButton, moreButton,
                extraButtonsBox);
    }
}
